...
export default function FriendsPopup({ userId, handleClose, isOpen }: Props) {
    ...
    return (
      ...
      <div className=" absolute flex flex-col space-y-4 bg-gray-200 rounded-lg shadow-lg w-96 p-4 h-auto border border-gray-500 place-items-center" onClick={handleClose}   >
